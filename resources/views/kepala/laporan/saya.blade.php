<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-end">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Pantau seluruh riwayat pelaporan kerusakan yang Anda buat.</p>
            </div>
    ...
    <div class="mb-6 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
        <form method="GET" action="{{ route('kepala.laporan_saya.index') }}" class="flex flex-col sm:flex-row items-end gap-4">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-900/50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Kerusakan</th>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <div class="font-medium text-gray-900 dark:text-gray-100">{{ $lap->judul }}</div>
                            <div class="text-gray-500 dark:text-gray-400 text-xs mt-1">{{ $lap->lokasi }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('kepala.laporan.show', $lap->id) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 transition-colors">Lihat Detail</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
