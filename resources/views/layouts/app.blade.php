                    ...
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3 relative">
                        <div x-data="{ notifOpen: false }">
                            ...
                            <div x-show="notifOpen" @click.away="notifOpen = false" style="display: none;"
                                ...
                                class="absolute right-0 top-full mt-3 w-[90vw] sm:w-80 max-w-[360px] bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-xl z-50 overflow-hidden transform origin-top-right">

                                <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 flex justify-between items-center">
                                    <h3 class="text-sm font-bold text-gray-900 dark:text-gray-100">Notifikasi Baru</h3>
                                    <span class="px-2 py-0.5 text-[10px] font-semibold bg-indigo-50 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 rounded-full">Pembaruan</span>
                                </div>

                                <div class="max-h-80 overflow-y-auto divide-y divide-gray-50 dark:divide-gray-700/50" id="notif-list-container">
                                    <div class="px-4 py-8 text-center flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm font-medium text-gray-900 dark:text-gray-200">Belum ada notifikasi</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Anda sudah membaca semuanya.</p>
                                    </div>
                                </div>
                ...
                .then(data => {
                    ...
                    if (data.count > 0) {
                        ...
                        if (data.latest) {
                            ...
                            <a href="#" class="block px-4 py-4 hover:bg-slate-50 dark:hover:bg-gray-700/50 transition-colors group relative">
                                <div class="flex gap-3">
                                    <div class="flex-shrink-0 mt-0.5">
                                        <div class="w-8 h-8 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate">${judul}</p>
                                        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1 line-clamp-2 leading-relaxed">${pesan}</p>
