            ...
            <form action="{{ route('admin.laporan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Format yang diizinkan: JPG, JPEG, PNG. Ukuran maksimal: 2 MB.</p>
                        <div class="mt-2 flex items-center justify-center w-full">
                            <label for="foto_sebelum" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Klik untuk unggah</span> atau seret file ke sini</p>
                                </div>
                                <input id="foto_sebelum" name="foto_sebelum" type="file" class="hidden" accept=".jpg,.jpeg,.png" required />
                            </label>
                        </div>
                        <p id="file-name" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 font-medium"></p>
                        @error('foto_sebelum')
                        <p class="mt-1 text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-end gap-x-4">
                    <a href="{{ route('admin.laporan.index') }}" class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 transition">Batal</a>
